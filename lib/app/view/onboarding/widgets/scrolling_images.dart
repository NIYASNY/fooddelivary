...
List<String> images = [
  AssetImagepath.kimage1,
  AssetImagepath.kimage2,
  AssetImagepath.kimage3,
  AssetImagepath.kimage4,
  AssetImagepath.kimage5,
  AssetImagepath.kimage6,
  AssetImagepath.kimage7,
  AssetImagepath.kimage8,
